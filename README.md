[![build](https://github.com/opspec-pkgs/aws.sts.assume-role/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/aws.sts.assume-role/actions/workflows/build.yml)
